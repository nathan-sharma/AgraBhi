...
| My current location is very close to my target GPS location I was assigned, so let me extend my soil sensor to the ground, take a reading, and transmit this data with my own special ID so the other rovers know who it came from.<br><br>**SWITCHED MODE TO TRANSMITTING** | [Pi 2 is driving to their target point] | [Laptop is waiting] |
