...
> **Note:** Without loss of generality, assume Pi 1 arrived at their assigned point before Pi 2. Read the cells with yellow squares first on every row.
